...
LastEditTime: 2023-08-05 21:39:24
FilePath: /pyplot/MachineLearning/xgboost-gnss.py
Descripttion: 
"""
...
def xgboost_gnss_predict(model, testdata):
    ...
    # print(satInfo.shape)
    # print(satInfo.describe())
    return satInfo


def out_gnss_data(rnx, outrnx, satInfo):
    result = {}
            ...
            for eachLine in content:
                ...
                if ender:
                    ...
                    if eachLine.startswith(">"):
                        ...
                        eachData = eachLine.split()
                        # los = satInfo.loc[(satInfo["week"] == 2261) & (satInfo["second"] == 354601.0) & (satInfo["sat"] == "G01"), :,]
                        los = satInfo.loc[
                            (satInfo["week"] == ws[0])
                            & (satInfo["second"] == ws[1])
...
if __name__ == "__main__":
    ...
    # xgboost_gnss_predict(modelpath2, path2)
    # xgboost_gnss_predict(modelpath1, path2)
    # xgboost_gnss_predict(modelpath2, path1)

    rnx = "./data/ml-data/trimble-3dma-0520.rnx"
    outrnx = "./data/ml-data/trimble-3dma-0520-ai.rnx"
    out_gnss_data(rnx, outrnx, satinfo_ref)
