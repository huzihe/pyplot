...
Date: 2023-06-18 16:58:50
LastEditTime: 2023-06-18 17:00:05
FilePath: /pyplot/MachineLearning/unclass-kmeans++.py
Descripttion: 
"""
...
for n_clusters in range(2, 5):
    # 聚类
    centers_init, indices = kmeans_plusplus(X, n_clusters, random_state=0)
    labels = kmeans_plusplus.predict(X)
