...
from com.readfile import ReadMyResult, ReadIERefResult, ReadGINSResult, ReadPandaResult
...
def DrawFigureLineWithSat(_stat, _stat2, _stat3, _satnum1, _figname):
    ...
    plt.plot(
        ...
        label=str(round(_stat3.rms[1]/100, 2)) + "/" + str(round(_stat3.rms[0]/100, 2)) + "/" + str(round(_stat3.rms[2]/100, 2)) +" PPP" ,
    )
    plt.plot(
        Time_hms[0 : len(_stat2.dy)],
        _stat2.dy,
        color='deeppink', linestyle='-', linewidth= lWidth, marker='o',markersize= mScale,
        label=str(round(_stat2.rms[1]/100, 2)) + "/" + str(round(_stat2.rms[0]/100, 2)) + "/" + str(round(_stat2.rms[2]/100, 2)) + " NLOS-W",
    )
    plt.plot(
        Time_hms[0 : len(_stat.dy)],
        _stat.dy,
        color='limegreen', linestyle='-', linewidth= lWidth, marker='o',markersize= mScale,
        label=str(round(_stat.rms[1]/100, 2)) + "/" + str(round(_stat.rms[0]/100, 2)) + "/" + str(round(_stat.rms[2]/100, 2)) + " PPP-RT",
    )
    #   plt.plot(Time_hms[0:len(_stat.dy)], _stat.dy, 'red', label = 'rms_L: ' + str(round(_stat.rms[1], 3)) + 'cm')
    # plt.legend(loc="lower right",ncol=3,handletextpad=0)
...
if __name__ == "__main__":
    ...
    deltname ="-PPP-S-ublox-0125"  # 文件标记
    ...
    calValue = ReadPandaResult(calFile1)
    calValue2 = ReadPandaResult(calFile2)
    calValue3 = ReadPandaResult(calFile3)
    ...
    # 带卫星数的统计
    nlosrnx = "../shadowmatching/ublox-3dma-0120.rnx"
