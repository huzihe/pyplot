...
def DrawFigure(_stat, _figname):
    ...
    plt.plot_date(
        ...
        _stat.dx,
        fmt="b.",
        label="rms_B: " + str(round(_stat.rms[0], 3)) + "cm",
    )
    ...
    plt.plot_date(
        ...
        _stat.dy,
        fmt="r.",
        label="rms_L: " + str(round(_stat.rms[1], 3)) + "cm",
    )
    ...
    plt.plot_date(
        ...
        _stat.dz,
        fmt="g.",
        label="rms_H: " + str(round(_stat.rms[2], 3)) + "cm",
    )
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 3:
        calFile = sys.argv[1]
        refFile = sys.argv[2]
    filename = calFile.split(".")[0]
    detFile = "det-" + filename + ".txt"
    figName = "fig-" + filename + ".png"

    calValue = Read3DMAResult(calFile)
